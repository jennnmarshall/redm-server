...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `crafting` longtext COLLATE utf8mb4_bin DEFAULT '{medical0,blacksmith0,basic0,survival0,brewing0,food0}',
...
INSERT INTO `items` (`item`, `label`, `limit`, `can_remove`, `type`, `usable`, `id`, `metadata`, `desc`) VALUES
	...
	('fertilizerpulpsap', 'Fertilizer with PulpSap', 10, 1, 'item_standard', 1, 741, '{}', 'nice item'),
